...
不过面前的三位灰袍人肯定不关心这一点。他们失焦的双目空洞地看着祭台上的书，嘴里无意识地发出呢喃。
- (opts)
    * (stone) [捡起石头]
        你从碎石堆里捡起数块石头。
    * (stick) [折下树枝]
...
= action
你试着打下那些闪光的符文……
它们就那样落了下来，洒得祭台上到处都是，漂浮一会后忽然变成深青色的腐蚀痕迹。
随着符文的一一落下，中间包裹的东西露了出来：
“东皇太一”的残骸。#CLASS: holy
一个拳头大小的金色精巧结构中嵌着几粒碎石。
#RANDOM: uniform_int_distribution 1 3
{t_random == 1:
    一丝灵感缠绕到你身上：那就是灰袍人所称的“神”。
}
三个灰袍人的躯壳忽然跌倒下来。你看见一本崭新的红色封皮的书掉了出来，似乎还有一些奇怪的文字。
* [拾起] -> c_end_why
* [等待]
    几只乌鸦惊叫着、拍打着翅膀飞开了。
    -> meet
